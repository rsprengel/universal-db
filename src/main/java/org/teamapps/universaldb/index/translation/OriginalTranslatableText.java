...
public class OriginalTranslatableText implements TranslatableTextIf {
	...
	public static OriginalTranslatableText create(String originalText, String originalLanguage) {
		return new OriginalTranslatableText(originalText, originalLanguage);
	}

	public OriginalTranslatableText() {
	}

	public OriginalTranslatableText(String originalText, String originalLanguage) {
	...
	public OriginalTranslatableText(String encodedValue) {
	...
	public OriginalTranslatableText(DataInputStream dataInputStream) throws IOException {
		encodedValue = DataStreamUtil.readStringWithLengthHeader(dataInputStream);
	}

	public OriginalTranslatableText(String originalText, String originalLanguage, Map<String, String> translationMap) {
	...
	public OriginalTranslatableText setTranslation(String translation, String language) {
	...
	// extensions for the new interface TranslatableTextIf


	@Override
	public boolean contains(String language) {
		return getTranslationMap().containsKey(language);
	}

	@Override
	public List<String> getLanguages() {
		return getTranslationMap().keySet().stream().toList();
	}
	...
	public boolean hasTranslations() {
		return getTranslationMap().size() > 1;
	}
	...
	public boolean isEmpty() {
		return TranslatableTextIf.isNull(this) || StringUtils.isEmpty(originalText);
	}
	...
	public boolean equalsOriginal(Object o) {
		...
		TranslatableTextIf that = (TranslatableTextIf) o;
		return Objects.equals(originalText, that.getText()) && Objects.equals(originalLanguage, that.getOriginalLanguage());
	}
