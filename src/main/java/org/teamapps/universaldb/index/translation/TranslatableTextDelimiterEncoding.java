...
public class TranslatableTextDelimiterEncoding implements TranslatableTextIf {
    ...
    public static boolean isNull(TranslatableTextDelimiterEncoding text) {
        return text==null || text.originalLanguage==null;
    }

    public TranslatableTextDelimiterEncoding() {
        originalLanguage = null;
    }

    public TranslatableTextDelimiterEncoding(String originalText, String originalLanguage) {
    ...
    public TranslatableTextDelimiterEncoding(String encodedValue) {
    ...
    public TranslatableTextDelimiterEncoding(DataInputStream dataInputStream) throws IOException {
    ...
    public TranslatableTextDelimiterEncoding setTranslation(String translation, String language) {
...
//            			initMembersFromEncodedText();
    ...
    public boolean equals(Object o) {
        ...
        TranslatableTextDelimiterEncoding that = (TranslatableTextDelimiterEncoding) o;
